...
v1.get('/master/division/:id', controller.apiControllers.attendanceControllers.master.division.getAll.requestHandler);
...
v1.get('/master/employee/:id', controller.apiControllers.attendanceControllers.master.employee.getAll.requestHandler);
v1.post('/master/employee/add', controller.apiControllers.attendanceControllers.master.employee.addOne.requestHandler);
v1.post('/master/employee/edit/:id', controller.apiControllers.attendanceControllers.master.employee.edit.requestHandler);
